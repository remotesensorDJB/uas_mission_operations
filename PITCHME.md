...
#### Misson Plan Design
##### Drone and Camera Type
@size[0.6em](The sensor used will define the resolution (GSD) of resultant imagery. The sensor's area, resolution, and lens focal length, all contribute to the calculated GSD at a given altitude.)
